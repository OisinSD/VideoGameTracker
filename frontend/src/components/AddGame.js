...
export default function AddGame({ show, handleClose, handleAddData }) {
  ...
  async function handleSubmit(e) {
    ...
    // Build the review data object to store in Firestore
    const reviewData = {
      rating: rating,
      review: review,
    ...
    try {
      // Add the reviewData to the gameReviews collection
      await addDoc(collection(db, "gameReviews"), reviewData);

      if (handleAddData) {
        handleAddData(reviewData);
      }
